...
def build_netlist(n_sections: int) -> dict:
    ...
    net: dict = {
        "instances": {
            ...
            "Vin": {"component": "voltage_source", "settings": {"V": V_STEP, "delay": DELAY, "tr": T_RISE}},
...
def run_one(n_sections: int) -> dict:
    ...
    saveat_w = diffrax.SaveAt(ts=jnp.array([0.0, float(WARMUP_STEPS * 1e-9)]), fn=save_io)
