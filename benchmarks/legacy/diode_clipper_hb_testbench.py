...
Usage
-----
  pixi run -e benchmark python benchmarks/legacy/diode_clipper_hb_testbench.py
  pixi run -e benchmark python benchmarks/legacy/diode_clipper_hb_testbench.py --plot
  pixi run -e benchmark python benchmarks/legacy/diode_clipper_hb_testbench.py --sweep
  pixi run -e benchmark python benchmarks/legacy/diode_clipper_hb_testbench.py --sweep --plot
  pixi run -e benchmark python benchmarks/legacy/diode_clipper_hb_testbench.py --n-harmonics 20
"""
