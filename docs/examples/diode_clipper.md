...
```
    ...
    WARNING:2026-04-15 16:19:11,990:jax._src.xla_bridge:864: An NVIDIA GPU may be present on this machine, but a CUDA-enabled jaxlib is not installed. Falling back to cpu.
...
```
    ...
    1. Compiling Circuit...
       ...
       Port Map: {'D1,p1': 1, 'R1,p2': 1, 'D2,p2': 1, 'D2,p1': 0, 'D1,p2': 0, 'Vin,p2': 0, 'GND,p1': 0, 'Vin,p1': 2, 'R1,p1': 2, 'Vin,i_src': 3}
    ...
    Performed 591 steps performed in 0.55 seconds
