...
```
    ...
    WARNING:2026-06-23 09:42:54,288:jax._src.xla_bridge:864: An NVIDIA GPU may be present on this machine, but a CUDA-enabled jaxlib is not installed. Falling back to cpu.
...
```
    ...
    Compilation finished in 1.2883s
    ...
    Simulation completed in 3.3410s
    Total Steps: 19662
